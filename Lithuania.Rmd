...
#df <- subset(df,location =="Lithuania"  )
...
ggplot() + geom_line(aes(x=date,y=new_cases)) +
  ...
  labs(title="Lithuania Daily Dailycases")
...
ggplot() +  geom_line(aes(x=date,y=new_deaths)) +
  ...
  labs(title="Lithuania Daily Deaths") 
...
#### Lithuania in the EU: Covid-19 Cases and Deaths
